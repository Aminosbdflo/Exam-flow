...
export default function Register() {
  const { loginWithGoogle, registerEmail } = useAuthStore()
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 bg-gradient-to-br from-background via-muted/20 to-background">
      <Card className="max-w-md w-full shadow-2xl border-primary/5 backdrop-blur-sm bg-card/95">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <p className="text-muted-foreground text-sm">Join the next generation of assessment.</p>
        </CardHeader>
        <CardContent className="space-y-6 pt-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1 text-left block">Password</label>
              <div className="relative">
